...
const MasInfoCookies = () => {
  const page = (pages as WpPage[]).find((item) => item.slug === 'mas-informacion-sobre-las-cookies');
  const title = page?.title ?? 'Más Información sobre las Cookies';
