...
const CookieBanner = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-[#4a7c59] text-white p-4 z-50">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-center gap-4">
        <p className="text-sm text-center md:text-left">
          ...
          que acepta nuestra{' '}
          <a href="#/politica-de-cookies/" className="underline hover:text-[#8bc34a] transition-colors">
            Política de cookies
          </a>
          , para más información lea{' '}
          <a href="#/mas-informacion-sobre-las-cookies/" className="underline hover:text-[#8bc34a] transition-colors">
            Aquí
          </a>
        </p>
        <button
